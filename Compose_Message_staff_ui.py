...
class Ui_Dialog(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.message_report, 3, 0, 1, 3)

        self.back_btn_composed_msg = QPushButton(self.frame)
        self.back_btn_composed_msg.setObjectName(u"back_btn_composed_msg")

        self.gridLayout_2.addWidget(self.back_btn_composed_msg, 0, 0, 1, 2, Qt.AlignLeft)
        ...
        self.gridLayout_2.addWidget(self.label_47, 1, 0, 2, 2, Qt.AlignLeft)

        self.send_btn_composed_msg = QPushButton(self.frame)
        self.send_btn_composed_msg.setObjectName(u"send_btn_composed_msg")

        self.gridLayout_2.addWidget(self.send_btn_composed_msg, 4, 2, 1, 1, Qt.AlignRight)
        ...
        self.gridLayout_2.addWidget(self.type_report, 2, 2, 1, 1)
...
"\n"
"", None))
        self.back_btn_composed_msg.setText(QCoreApplication.translate("Form", u"Back", None))
